...
import com.example.testing.MenuFiles.ProfileActivity;
import com.example.testing.model.Orders;
import com.example.testing.viewholder.OrdersViewHolder;
...
public class ShowHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartyToolbar=findViewById(R.id.cart_toolbar);
        cartyToolbar.setBackgroundResource(R.drawable.bg_color);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Orders> options=new FirebaseRecyclerOptions.Builder<Orders>()
                .setQuery(ordersRef.child("Orders").child(auth.getCurrentUser().getUid()).child("History")
                ,Orders.class).build();
        ...
        FirebaseRecyclerAdapter<Orders, OrdersViewHolder> adapter=
                new FirebaseRecyclerAdapter<Orders, OrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull OrdersViewHolder holder, int position, @NonNull Orders model) {
                        ...
                        holder.orderAdr.setText(model.getAddress());
